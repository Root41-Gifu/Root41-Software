...
//   do {                               \
//     if ((m) == SimpleWire_1M)        \
//       SimpleWire_1M_THDSTA;          \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_THDSTA;        \
//     else                             \
//       SimpleWire_100K_THDSTA;        \
//   } while (0)
...
//       SimpleWire_1M_TLOW;            \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_TLOW;          \
//     else                             \
//       SimpleWire_100K_TLOW;          \
//   } while (0)
...
//       SimpleWire_1M_THIGH;           \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_THIGH;         \
//     else                             \
//       SimpleWire_100K_THIGH;         \
//   } while (0)

// #define SimpleWire_DELAY_TSUSTA(m)   \
//   do {                               \
//     if ((m) == SimpleWire_1M)        \
//       SimpleWire_1M_TSUSTA;          \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_TSUSTA;        \
//     else                             \
//       SimpleWire_100K_TSUSTA;        \
//   } while (0)

// #define SimpleWire_DELAY_THDDAT(m)   \
//   do {                               \
//     if ((m) == SimpleWire_1M)        \
//       SimpleWire_1M_THDDAT;          \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_THDDAT;        \
//     else                             \
//       SimpleWire_100K_THDDAT;        \
//   } while (0)

// #define SimpleWire_DELAY_TSUSTO(m)   \
//   do {                               \
//     if ((m) == SimpleWire_1M)        \
//       SimpleWire_1M_TSUSTO;          \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_TSUSTO;        \
//     else                             \
//       SimpleWire_100K_TSUSTO;        \
//   } while (0)

// #define SimpleWire_DELAY_TSUDAT(m)   \
//   do {                               \
//     if ((m) == SimpleWire_1M)        \
//       SimpleWire_1M_TSUDAT;          \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_TSUDAT;        \
//     else                             \
//       SimpleWire_100K_TSUDAT;        \
//   } while (0)
...
//       SimpleWire_1M_TBUF;            \
//     else if ((m) == SimpleWire_400K) \
//       SimpleWire_400K_TBUF;          \
//     else                             \
//       SimpleWire_100K_TBUF;          \
//   } while (0)
...
//       // read data
//       for (cnt = 0; cnt < len; ++cnt) *buf++ = read();
//     }
//     // stop
//     stop();
//     return cnt;
...
//  public:
//   TwoWire(void) : _count(0), _index(0), _error(0), _addr(0) {}

//   virtual ~TwoWire(void) {}

//   void begin(void) { SimpleWire<MODE>::begin(); }
...
//     if (_error) return 1;  // buffer overflow
//     int rv = SimpleWire<MODE>::write(_addr, _buffer, _index);
//     if (rv == _index) return 0;  // success
//     return (rv < 0 ? 2 : 3);
//   }
...
//       // access some devices' internal registers. This function is executed by
//       // the hardware TWI module on other processors (for example Due's TWI_IADR
//       // and TWI_MMR registers)
...
//     if (_index < _count) value = _buffer[_index++];
//     return value;
//   }
